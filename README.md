...
- [AAVE Liquidity Protocol](https://aave.com/) - Decentralized non-custodial liquidity protocol where users can participate as depositors or borrowers. Available on Ethereum, Avalanche, Polygon, Fantom, Harmony, Optimism, Arbitrum. [Source](https://github.com/aave)
