...
- [ipfs-search](https://ipfs-search.com) - IPFS search engine Sniffs the DHT gossip and indexes file and directory hashes. Metadata and search API's available. [Source](https://github.com/ipfs-search/ipfs-search)
...
- [7-piece Syzygy tablebases](https://ipfs.io/ipfs/QmVgcSADsoW5w19MkL2RNKNPGtaz7UhGhU62XRm6pQmzct) - Solutions for all chess endgames with up to 7 pieces. [Source](https://github.com/syzygy1/tb)
...
- [Brainwash Dataset](https://ipfs.io/ipfs/QmZ8BpYCtcPeA5g6uXciNXN395WeqZYNVNvz4xvBxsfxqy) Stewart, Russell. (2015). Brainwash dataset. [Source](https://purl.stanford.edu/sx925dc9385)
...
- [CrowdHuman Dataset](https://ipfs.io/ipfs/QmTgBpFRM1K4gGyLKSv7tJnEkZZcEQcswnGDdBYkCRu6Vw) - CrowdHuman dataset. A Benchmark for Detecting Human in a Crowd [Source](http://www.crowdhuman.org/download.html)
...
- [WistfulBooks: LibriVox Audiobook Archive](https://ipfs.io/ipfs/QmXyNMhV8bQFp6wzoVpkz3NqDi7Fj72Deg7KphAuew3RYU) - Free public domain audiobooks from LibriVox.org packaged into a single page that lets you listen to audiobooks in your browser. [Source](https://github.com/smwa/wistfulbooks)
