...
- [Testcorpus for Image Compression Algoritms](https://twitter.com/RubenKelevra/status/1236525895000653824) - A testcorpus with a large variety of low or no compression artifact images and animations of high fidelity for testing image compression algorithms. The CID allows for easy access/validation of the integrity of the dataset while making sure all data is permanently available without having to rely on third-party servers. All images are either copyleft or without any copyright restrictions. This is just a CDN like cache of those data, details for the licenses for other purposes than research can be found on the source pages of those individual images. [Source](Wikipedia Commons / Library Of Congress / NASA / NOAA)
