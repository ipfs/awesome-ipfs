...
- [Shasta](https://shasta.world/) - A decentralized, peer-to-peer energy market built on the Ethereum blockchain and embedded into IPFS. [Source](https://github.com/Shasta)
